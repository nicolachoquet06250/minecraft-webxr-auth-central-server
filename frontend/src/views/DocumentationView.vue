  ...
  <main class="documentation voxicraft-bg">
    <section class="voxicraft-panel documentation-panel">
      <header class="documentation-header">
        ...
        <p class="documentation-intro">Quick start serveur, API centrale générée depuis OpenAPI et documentation expérimentale des mods.</p>
      </header>
      ...
      <div class="documentation-layout">
        ...
        <div class="documentation-content">
          <section id="quick-start" class="documentation-section">
...
./voxicraft_server</pre></article>
          ...
          <section id="api-doc" class="documentation-section">
          ...
          <section id="mods-doc" class="documentation-section">
...
.documentation-menu a, .download-link { color: #1a1a1a; background: #64ffda; border: 2px solid #1a1a1a; border-radius: 8px; padding: .9rem 1rem; text-decoration: none; font-weight: 700; line-height: 1.45; box-shadow: 3px 3px 0 rgba(0,0,0,.35); }
.documentation-content { min-width: 0; }
.documentation-section { padding-top: 1.5rem; margin-top: 3.75rem; scroll-margin-top: 110px; }
.documentation-section:first-child { margin-top: 0; }
...
@media (max-width: 768px) { .documentation { padding: 1rem .55rem; } .documentation-panel { padding: 1rem; } .doc-grid { grid-template-columns: 1fr; } .doc-card { padding: 1rem; } .documentation-menu a { text-align: center; } }
</style>
