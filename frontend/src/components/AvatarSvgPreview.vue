...
type AvatarPreviewPose = 'idle' | 'walking'

const props = defineProps<{ avatar?: string; customAvatar?: UserAvatar; pose?: AvatarPreviewPose }>()
const svgUrl = ref('')
...
const renderSvg = () => {
  ...
  if (props.pose === 'walking') applyWalkingPose(mesh)
